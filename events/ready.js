...
module.exports = {
  ...
  execute(client) {
    try {
      ...
      // Setting the bot status to STREAMING with the provided Twitch link
      client.user.setActivity('Rosie_qq on Twitch', { type: ActivityType.Streaming, url: 'https://www.twitch.tv/rosie_qq' });
